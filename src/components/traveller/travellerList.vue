...
export default {
  ...
  data() {
    return {
      ...
      filter: null,
      fields: [
        {key: 'picture', label: 'Ürün resmi ', sortable: true, class: 'text-center'},
        {key: 'name', label: 'Ürün Adı ', sortable: true, class: 'text-center'},
        {key: 'description', label: 'Ürün Açıklama', sortable: true, class: 'text-center'},
        {key: 'category.name', label: 'Ürün kategorisi', sortable: true, class: 'text-center'},
